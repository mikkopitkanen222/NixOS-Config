...
let
  ...
  hyprConfigFiles = {
    main = ''
      ...
      require("mp222/windowrules")
      require("mp222/workspaces")
      require("mp222/binds")
    ...
    windowrules = ''
      ...
      ${lib.concatMapStringsSep "\n" (
        rule: "hl.window_rule(${nix2lua rule})"
      ) cfg.windowrules}
    '';
    ...
    workspaces = ''
      ...
      ${lib.concatMapStringsSep "\n" (
        rule: "hl.workspace_rule(${nix2lua rule})"
      ) cfg.workspaces}
    '';
...
in
{
  options.mp222.hyprland = {
    ...
    windowrules = lib.mkOption {
      type = listOf settingValueType;
      default = [ ];
      description = "List of attribute sets describing Hyprland windowrules.";
      example = [
        {
          name = "float-clipse";
          match.class = "clipse";
    ...
    workspaces = lib.mkOption {
      type = listOf settingValueType;
      default = [ ];
      description = "List of attribute sets describing Hyprland workspaces.";
      example = [
        {
          workspace = "1";
          monitor = "DP-1";

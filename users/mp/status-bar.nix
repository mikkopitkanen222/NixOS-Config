# Configure Waybar, a bar for Wayland.
...
}:
{
    ...
    settings = {
      mainBar = {
        ...
        temperature = {
          hwmon-path =
            {
              desknix = "/sys/class/hwmon/hwmon4/temp1_input";
              lapnix = "/sys/class/hwmon/hwmon2/temp1_input";
              previousnix = "";
            }
  ...
  # Waybar has a more featureful network module; iwgtk -i is not needed.

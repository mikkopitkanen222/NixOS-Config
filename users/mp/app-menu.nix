# Configure tofi, a dynamic menu for Wayland.
...
{ ... }:
{
  ...
  programs.tofi = {
    ...
    settings = {
      ...
      # "font-feature-settings" property. Examples:
      ...
      # "font-variation-settings" property. Examples:
      ...
      # *-background-padding: Background padding in pixels (comma-delimited, CSS-style list).
      # *-background-corner-radius: Radius of background box corners in pixels
      ...
      # If unspecified, these all default to the corresponding default-result-* attribute.
      ...
      # algorithm. Supported values: normal, prefix, fuzzy
